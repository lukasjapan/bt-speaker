...
apt-get update
apt-get --yes --force-yes install git bluez python3 python3-gobject python3-cffi python3-dbus python3-alsaaudio python3-configparser sound-theme-freedesktop vorbis-tools
echo "done."
